...
func Record(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf("https://restapi.amap.com/v3/assistant/coordinate/convert?key=%s&locations=%s,%s&coordsys=gps", config.Record.MapApiKey, Msg.Longitude, Msg.Latitude)
	...
	url = fmt.Sprintf("https://restapi.amap.com/v3/geocode/regeo?key=%s&location=%s&poitype=&radius=0&extensions=all&batch=false&roadlevel=0", config.Record.MapApiKey, Msg.AMapCoordinates)
